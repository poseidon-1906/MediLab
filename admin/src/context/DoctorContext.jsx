...
const DoctorContextProvider = (props) => {
    ...
    // Function to get patient records for a doctor
    const getPatientRecordsForDoctor = async (patientId) => {
        try {
            const { data } = await axios.get(backendUrl + `/api/doctor/records/patient/${patientId}`, { headers: { dtoken: dToken } });
            if (data.success) {
                return data.data;
            } else {
                toast.error(data.message);
